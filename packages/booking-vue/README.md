# @widgetkit/booking-vue

A clean, accessible booking scheduler component for Vue 3. Supports month + day views, per-slot pricing, variable durations, and flexible display modes — with zero dependencies beyond Vue itself.
...
```bash
npm install @widgetkit/booking-vue
# or
pnpm add @widgetkit/booking-vue
# or
yarn add @widgetkit/booking-vue
```
...
```ts
import { generateSlots } from "@widgetkit/booking-vue";
