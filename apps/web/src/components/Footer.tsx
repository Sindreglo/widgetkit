  ...
  return (
    <footer className="footer">
      <div className="footer-inner">
        ...
        <p className="footer-tagline">Production-ready UI widgets for developers.</p>
        ...
        <div className="footer-bottom">
          <span>© {new Date().getFullYear()} Widgetkit by <a href="https://github.com/Sindreglo" target="_blank" rel="noopener noreferrer">Sindre Glomnes</a> — MIT License</span>
